...
<head>
    <meta charset="UTF-8">
    <title>Add Movie Form - Laravel 10 CRUD</title>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Movie Gener:</strong>
                 <input type="text" name="gener" class="form-control" placeholder="Movie Gener">
                <!-- @error('address')
                  <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
               @enderror -->
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Movie Image:</strong>
                 <input type="file" name="image" class="form-control" placeholder="Movie Image">
                <!-- @error('address')
                  <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
               @enderror -->
            </div>
